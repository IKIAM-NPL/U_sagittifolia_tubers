...
# Save plot
#ggsave('Result/LC-MS_Negative/LC_MS_Negative_Score_Plot.png', width = 6.5, height = 4.3, device='png', dpi=300)
```  
...
# Save plot
#ggsave('Result/LC-MS_Negative/LC_MS_Negative_Loadings_Plot.png', width = 13, height = 7.5, device='png', dpi=700)
